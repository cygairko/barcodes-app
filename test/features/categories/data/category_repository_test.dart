...
void main() {
  ...
  final categoryNoId1 = const Category(name: 'Electronics');
  final categoryNoId2 = const Category(name: 'Books');
  ...
  group('CategoryRepository with Sembast', () {
    ...
    group('updateCategory', () {
      ...
      test('should throw an exception when updating a category with null ID', () async {
        final categoryWithNullId = const Category(name: 'Test Category');
        expect(
      ...
      test('should throw an exception when updating a non-existent category ID', () async {
        final nonExistentCategory = const Category(id: 999, name: 'Non Existent');
        expect(
